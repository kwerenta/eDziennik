  ...
  <ul class="navbar__list">
    ...
    <li class="navbar__item">
      <a href="/student/" class="navbar__link">
        ...
        <span class="navbar__text">Pulpit</span>
      </a>
    </li>
    <li class="navbar__item">
      <a href="/student/grades.php" class="navbar__link">
        ...
        <span class="navbar__text">Oceny</span>
      </a>
    </li>
    <li class="navbar__item">
      <a href="/student/notes.php" class="navbar__link">
        ...
        <span class="navbar__text">Uwagi</span>
      </a>
    </li>
    <li class="navbar__item">
